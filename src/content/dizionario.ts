...
export const dizionari: Record<Locale, Dizionario> = {
	it: {
		...
		doveSottotitolo: "Le date dei prossimi mercatini. Se passi, fermati a salutare.",
	...
	en: {
		...
		doveSottotitolo: "The markets I'll be at over the coming months. Stop and say hello.",
